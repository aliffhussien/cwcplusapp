...
export default function AuthModal({ isOpen, onClose }) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        // Browser will redirect to Google — no need to close modal manually
    };
                        ...
                        <div className="relative z-10 p-8 pt-10">
                            ...
                            <div className="mb-8">
                                <h2 className="text-3xl font-black text-white mb-1.5 tracking-tight">
                                    {isLogin ? 'Welcome back 👋' : 'Join CWC+ 🍳'}
                                </h2>
                                <p className="text-sm font-medium text-slate-400">
                                    {isLogin
                                        ? 'Sign in to access your culinary vault.'
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Lock size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none" />
                                        <input
                                            type="password"
                                            required
                                            value={password}
